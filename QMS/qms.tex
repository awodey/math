...
\begin{proof}
To show that $\,\U$ is fibrant, we need to solve the following filling problem for an arbitrary cofibration $c:C \cof Z$, thus showing that $\,\U^{\delta_0} : \U^\I \ra\, \U$ is a trivial fibration (for, say, the point $\delta_0 :1\ra \I $).
