...
%
%Recall further that a map $f: X\to Y$ in \cSet\ is called a \emph{homotopy equivalence} if there is a \emph{quasi-inverse} $g: Y\to X$ and homotopies $\vartheta : 1_X \sim g\circ f$ and $\varphi : 1_Y\sim f\circ g$.
%
%\begin{definition}[Weak homotopy equivalence]
%A map $f: X\to Y$ will be called a \emph{weak homotopy equivalence} if the associated map between fibrant replacements $f' : X' \to Y'$ is a homotopy equivalence.
%\end{definition}
%
%\begin{proposition}
%If $Y$ is fibrant, then the relation of homotopy $f \sim g$ between maps $f,g: X\rightrightarrows Y$ is an equivalence relation.  Moreover, homotopy equivalences $f : X\ra Y$ between fibrant objects $X, Y$ satisfy the 3-for-2 condition. 
%\end{proposition}
%
%\begin{corollary}
%The weak homotopy equivalences $f : X\ra Y$ (among any objects $X, Y$) satisfy the 3-for-2 condition. 
%\end{corollary}
%
%Thus our goal of showing that the weak equivalences satisfy 3-for-2 is reduced to the following:
%\begin{proposition}
%A map $f: X\ra Y$ is a weak equivalence if and only if it is a weak homotopy equivalence, i.e.\ iff $f' : X'\ra Y'$ is a homotopy equivalence.
%\end{proposition}
%%
