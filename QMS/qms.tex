...
Finally, for the case of unbiased filling we need the more general form of composition going from one generic point $p : 1\ra\II$ to another $q : 1\ra\II$, rather than from one endpoint to another.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{The fibration extension property}\label{sec:FEP}
...
An application of the alignment lemma \ref{lem:alignment} completes the proof.
\end{proof}
