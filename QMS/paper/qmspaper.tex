...
Throughout this section we shall consider only the case of $\delta$-biased fibrations in $\cSet/_\I$. The EEP for this case will suffice to establish the model structures for both this case and for the unbiased fibrations in $\cSet$.  (The EEP for unbiased fibrations will then be shown by a different argument, in Proposition \ref{prop:EECunbiased}).  Thus for the remaineder of this section, ``fibration'' always means $\delta$-biased fibration in $\cSet/_\I$, and  $\delta : 1 \to\I$ is the diagonal $\I \to \I\times\I$ as a map over $\I$ in $\cSet$.
