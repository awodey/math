...
\ednote{$\mathbbm{1}\to \mathbbm{2}$ classifies what in $\Cat$}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Acknowledgement}

Thanks to Mathieu Anel and Emily Riehl for discussions, and to Evan Cavallo and Taichi Uemura for the reference to Grothendieck for the nerve functor.
